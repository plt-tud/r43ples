...
//	 */
//	public MergeCommitDraft(String graphName, String addSet, String deleteSet, String user, String timeStamp, String message, String derivedFromIdentifier) throws InternalErrorException {
//		super(null);
...
//	 */
//	public List<Commit> createCommitInTripleStore() throws InternalErrorException {
//
//		if (isCreatedWithRequest) {
//			revisionDraft.createRevisionInTripleStore();
//			addNewRevisionFromChangeSet(revisionDraft);
//		} else {
//			updateChangeSetsByRewrittenQuery();
//		}
//
...
//	 * @throws InternalErrorException
//	 */
//	private void updateChangeSetsByRewrittenQuery() throws InternalErrorException {
//
...
//	 * Applies changeset to full graph and adds meta information in revision graph.
//	 *
