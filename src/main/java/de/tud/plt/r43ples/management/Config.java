...
/**
 * General configuration handling. Stores all important configuration from
 * R43ples. Can read from configuration file.
 * 
...
public class Config {
	...
	public static void readConfig(final String configFilePath) throws ConfigurationException {
		...
		try {
			...
			logger.warn("Could not read configuration file '" + configFilePath
					+ "'. Switch to 'r43ples.dist.conf'.");
