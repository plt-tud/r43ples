 ...
 */
public class PickMergeCommit extends MergeCommit {

    /** The logger. **/
    private Logger logger = Logger.getLogger(PickMergeCommit.class);
     ...
     */
    public PickMergeCommit(RevisionGraph revisionGraph, String commitURI) throws InternalErrorException {
     ...
     * @throws InternalErrorException
     */
    public PickMergeCommit(RevisionGraph revisionGraph, String commitURI, String user, String timeStamp, String message,
