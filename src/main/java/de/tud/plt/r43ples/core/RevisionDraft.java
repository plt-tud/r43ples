...
public class RevisionDraft {
    ...
    /**
     * Usage only for initial commit (there is no derived from revision/branch, initial revision identifier will be calculated).
...
//     * @throws InternalErrorException
//     */
//    protected RevisionDraft(RevisionManagement revisionManagement, RevisionGraph revisionGraph, String derivedFromIdentifier) throws InternalErrorException {
//        // Dependencies
//        this.tripleStoreInterface = TripleStoreInterfaceSingleton.get();
//
//        this.revisionManagement = revisionManagement;
...
//    }
    ...
    protected Revision createInTripleStore() throws InternalErrorException {
        ...
        ChangeSetDraft changeSetDraft = new ChangeSetDraft(revisionManagement, revisionGraph, derivedFromRevision, newRevisionIdentifier, referenceFullGraph, addSet, deleteSet, isStripped);
    ...
    public boolean equals(final String graphName, final String revisionIdentifier) throws InternalErrorException{
		...
		return ((this.revisionGraph.getGraphName().equals(graphName)) && (this.derivedFromRevision.getRevisionIdentifier().equals(otherRevisionNumber)));
	}
