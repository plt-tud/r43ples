  ...
  <div class="fixed">
    <nav class = "top-bar" data-topbar role = "navigation">
      ...
      <section class="top-bar-section">
          ...
          <!-- Left Nav Section -->
          <ul class="right">
            <li><div style="margin:6px; padding:3px;" ><em style="margin:16px; padding:8px; color:white;"> Version: ${version!"  "} 
              Git: ${git.commitIdAbbrev!"  "} - ${git.branch!"  "} </em></div></li>
            <li class="divider"></li>
...
<!--  At the end in order to load the page faster-->
