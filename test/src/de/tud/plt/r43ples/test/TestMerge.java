...
public class TestMerge {
	...
	public void testCreatedGraph() throws IOException, SAXException, HttpException {
		...
		String expected1 = DatasetGenerationManagement.readFileToString("test/resources/merge/response-B1.xml");
		assertXMLEqual(expected1, result1);
		
		// Test branch B1X
		String result2 = executeR43plesQuery(createSelectQuery(graphName, "B1X"));
		String expected2 = DatasetGenerationManagement.readFileToString("test/resources/merge/response-B1X.xml");
		assertXMLEqual(expected2, result2);
		
		// Test branch B2
		String result3 = executeR43plesQuery(createSelectQuery(graphName, "B2"));
		String expected3 = DatasetGenerationManagement.readFileToString("test/resources/merge/response-B2.xml");
		assertXMLEqual(expected3, result3);
		
		// Test branch B2X
		String result4 = executeR43plesQuery(createSelectQuery(graphName, "B2X"));
		String expected4 = DatasetGenerationManagement.readFileToString("test/resources/merge/response-B2X.xml");
		assertXMLEqual(expected4, result4);
		
		// Test branch MASTER
		String result5 = executeR43plesQuery(createSelectQuery(graphName, "master"));
		String expected5 = DatasetGenerationManagement.readFileToString("test/resources/merge/response-MASTER.xml");
	...
	public void testAutoMerge() throws IOException, SAXException, HttpException {
		...
		// Test branch B1
		String result1 = executeR43plesQuery(createSelectQuery(graphName, "B1"));
		String expected1 = DatasetGenerationManagement.readFileToString("test/resources/merge/auto/response-B1-B1X-into-B1.xml");
		assertXMLEqual(expected1, result1);
		...
		String expected2 = DatasetGenerationManagement.readFileToString("test/resources/merge/auto/response-B2-B2X-into-B2.xml");
		assertXMLEqual(expected2, result2);
		...
		// Test branch B2
		String result3 = executeR43plesQuery(createSelectQuery(graphName, "B2"));
		String expected3 = DatasetGenerationManagement.readFileToString("test/resources/merge/auto/response-B2-B1-into-B2.xml");
		assertXMLEqual(expected3, result3);
		...
		String expected4 = DatasetGenerationManagement.readFileToString("test/resources/merge/auto/response-MASTER-B2-into-MASTER.xml");
		assertXMLEqual(expected4, result4);
	}
	...
	public void testCommonMerge() throws IOException, SAXException, HttpException {
		...
		// Test branch B1
		String result1 = executeR43plesQuery(createSelectQuery(graphName, "B1"));
		String expected1 = DatasetGenerationManagement.readFileToString("test/resources/merge/common/response-B1-B1X-into-B1.xml");
		assertXMLEqual(expected1, result1);
		...
		// Test branch B2
		String result2 = executeR43plesQuery(createSelectQuery(graphName, "B2"));
		String expected2 = DatasetGenerationManagement.readFileToString("test/resources/merge/common/response-B2-B2X-into-B2.xml");
		assertXMLEqual(expected2, result2);
		...
		// Test branch B2
		String result3 = executeR43plesQuery(createSelectQuery(graphName, "B2"));
		String expected3 = DatasetGenerationManagement.readFileToString("test/resources/merge/common/response-B2-B1-into-B2.xml");
		assertXMLEqual(expected3, result3);
		...
		// Test branch MASTER
		String result4 = executeR43plesQuery(createSelectQuery(graphName, "master"));
		String expected4 =DatasetGenerationManagement.readFileToString("test/resources/merge/common/response-MASTER-B2-into-MASTER.xml");
		assertXMLEqual(expected4, result4);
	}
	...
	public void testManualMerge() throws IOException, SAXException, HttpException {
		...
		// Test branch B1
		String result1 = executeR43plesQuery(createSelectQuery(graphName, "B1"));
		String expected1 = DatasetGenerationManagement.readFileToString("test/resources/merge/manual/response-B1-B1X-into-B1.xml");
		assertXMLEqual(expected1, result1);
		...
		// Test branch B2
		String result2 = executeR43plesQuery(createSelectQuery(graphName, "B2"));
		String expected2 = DatasetGenerationManagement.readFileToString("test/resources/merge/manual/response-B2-B2X-into-B2.xml");
		assertXMLEqual(expected2, result2);
		...
		// Test branch B2
		String result3 = executeR43plesQuery(createSelectQuery(graphName, "B2"));
		String expected3 = DatasetGenerationManagement.readFileToString("test/resources/merge/manual/response-B2-B1-into-B2.xml");
		assertXMLEqual(expected3, result3);
		...
		// Test branch MASTER
		String result4 = executeR43plesQuery(createSelectQuery(graphName, "master"));
		String expected4 = DatasetGenerationManagement.readFileToString("test/resources/merge/manual/response-MASTER-B2-into-MASTER.xml");
		assertXMLEqual(expected4, result4);
	}
