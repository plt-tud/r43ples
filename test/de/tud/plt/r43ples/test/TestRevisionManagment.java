...
public class TestRevisionManagment {
	...
	public void setUp() throws AuthenticationException, IOException, ConfigurationException{
		...
		RevisionManagement.putGraphUnderVersionControl("test123");
	}
	
	@After
	public void tearDown() throws AuthenticationException, IOException{
		RevisionManagement.purgeGraph("test123");
	}
	...
	public void testR43ples() throws AuthenticationException, IOException {
		RevisionManagement.putGraphUnderVersionControl("test123");
		String revNumberMaster = RevisionManagement.getMasterRevisionNumber("test123");
		Assert.assertEquals("0", revNumberMaster);
		
		ArrayList<String> list = new ArrayList<String>();
		list.add("0");
		
		RevisionManagement.createNewRevision("test123", "<a> <b> <c>.", "", "test", "1", "test commit message", list);
		
		revNumberMaster = RevisionManagement.getMasterRevisionNumber("test123");
