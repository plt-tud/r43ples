...
\section{Mockups}
\begin{figure}
    \subfloat[Darstellung des Graphen und des gesamten Changesets bei Klick]{\includegraphics[width=0.49\textwidth]{Mockup_Changeset.png}}
    \subfloat[Anzeige spezifischer Informationen bei Mouseover]{\includegraphics[width=0.49\textwidth]{Mockup_Mouseover.png}}
...
\label{sec:Loesung}
\begin{figure}   
    \subfloat[Graph mit Zeitachse und Revision 4 angeklickt  \label{fig:graph_detail}]{\includegraphics[width=0.49\textwidth]{detail_graph.jpg}}   
    \subfloat[Graph ohne Zeitachse, keine Version angeklickt  \label{fig:graph_einfach}]{\includegraphics[width=0.49\textwidth]{graph_ohne_achse.jpg}}\\   
    \subfloat[Add und Delete Sets zu Revision 4  \label{fig:graph_changeset}]{\includegraphics[width=0.49\textwidth]{detail.jpg}}
    \subfloat[Darstellung eines komplizierteren Graphen mit angelickter Revision 9 und Mouseover Feld von Revision 7 \label{fig:graph_mouseover}]{\includegraphics[width=0.49\textwidth]{tooltip_click.jpg}}
\caption{Darstellung der Lösung}
\label{fig:Loesung}
\end{figure}
